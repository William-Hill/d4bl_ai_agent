...
def test_build_records_county():
    headers = ["NAME", "P1_001N", "P1_003N", "P1_004N", "P1_005N",
               "P1_006N", "P1_007N", "P1_008N", "P1_009N", "P2_002N",
               "state", "county"]
    rows = [
        ["Example County, Alabama", "1000", "600", "200", "10",
         "50", "5", "35", "100", "80", "01", "001"],
    ]
...
def test_build_records_tract():
    headers = ["NAME", "P1_001N", "P1_003N", "P1_004N", "P1_005N",
               ...
               "state", "county", "tract"]
    rows = [
        ["Tract 1, County, State", "500", "300", "100", "5",
         "25", "2", "18", "50", "40", "01", "001", "000100"],
    ]
...
def test_build_records_skips_invalid_population():
    headers = ["NAME", "P1_001N", "P1_003N", "P1_004N", "P1_005N",
               ...
               "state", "county"]
    rows = [
        ["Bad County", "N/A", "N/A", "N/A", "N/A",
         "N/A", "N/A", "N/A", "N/A", "N/A", "01", "001"],
    ]
    records = _build_records(headers, rows, "county", 2020)
