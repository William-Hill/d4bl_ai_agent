  ...
  return (
    <div className="bg-[#292929] border border-[#404040] rounded-lg p-6 flex flex-col">
      ...
      {colabUrl && colabUrl !== '#' ? (
        ...
        <span className="inline-flex items-center gap-2 px-4 py-2 bg-[#404040]/50 border border-[#404040] rounded-lg text-sm text-gray-500 self-start cursor-not-allowed">
          Coming Soon
        </span>
      )}
    </div>
