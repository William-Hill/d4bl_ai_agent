...
class Settings:
    # Environment
    is_docker: bool = os.path.exists("/.dockerenv") or bool(os.getenv("DOCKER_CONTAINER"))
    ...
    # Database
    postgres_user: str = os.getenv("POSTGRES_USER", "d4bl_user")
    postgres_password: str = os.getenv("POSTGRES_PASSWORD", "d4bl_password")
