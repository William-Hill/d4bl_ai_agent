"""Geographic constants shared across ingestion and training scripts.

This module has no external dependencies so it can be safely imported
in CI environments that don't install psycopg2.
"""
